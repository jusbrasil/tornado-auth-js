(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactComponents"] = factory(require("crypto"));
	else
		root["ReactComponents"] = factory(root["crypto"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var get_secure_cookie = exports.get_secure_cookie = function get_secure_cookie(cookie_name, value) {
	  var max_age_days = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
	...
	var get_current_user = exports.get_current_user = function get_current_user(value) {
	  var max_age_days = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
